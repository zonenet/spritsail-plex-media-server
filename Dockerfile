ARG PLEX_VER=1.32.7.7621-871adbd44
ARG PLEX_SHA=899db54abb59a9358ed6775358ca11d0b31d091b
ARG BUSYBOX_VER=1.36.1
ARG SU_EXEC_VER=0.4
ARG TINI_VER=0.19.0
ARG ZLIB_VER=1.3
ARG LIBXML2_VER=v2.11.5
ARG LIBXSLT_VER=v1.1.38
ARG XMLSTAR_VER=1.6.1
ARG OPENSSL_VER=3.0.11
ARG CURL_VER=curl-8_4_0
